...
if ($result->num_rows > 0) {
    ...
    if ($currentQuantity >= $quantity) {
        ...
        if ($conn->query($updateSql) === TRUE) {
            ...
            $insertSql = "INSERT INTO pharmacy_sales (article, info, quantity, price, cost, dateandtime, stocker, status,type, day, month, year ,patient)
                          VALUES ('$article', '$info', '$quantity', '$price', '$cost', '$timestamp', '$stocker', '$status','$type', '$day', '$month', '$year','$patient')";
