...
#totalValue {
    color: lightgreen;
    font-size: 50px; /* Set the initial color to light neon green */
    text-shadow: 0 0 5px #00ff00, 0 0 10px #00ff00, 0 0 15px #00ff00, 0 0 20px #00ff00, 0 0 25px #00ff00, 0 0 30px #00ff00, 0 0 35px #00ff00; /* Neon glow effect */
...
#navbar2 input[type="text"] {
    ...
    padding: 0px; /* Padding inside the input field */
...
#navbar2 input[type="text"]:focus {
    border-color: #33ff33; /* Brighter neon green when focused */
}
...
#cartTable td {
    ...
    text-align: center;
    font-size: 15px;
    color: #00ff00; /* Set font color to neon green */
}
...
#looksGoodButton {
    ...
    padding: 10px 20px;
    font-size: 16px;
    border: 3px solid lightgreen; /* Specify border color */
    border-radius: 5px;
    cursor: pointer;
    width: 100%;
    height: 50px;
...
/* Style for the input field */
.input-receipt {
    border: 2px solid #00ff00; /* Initial neon green border */
    border-radius: 5px; /* Rounded corners */
...
.input-receipt:focus {
    border-color: #33ff33; /* Brighter neon green when focused */
    box-shadow: 0 0 10px #33ff33; /* Neon green glow when focused */
}
...
<nav>
  <div class="nav-wrapper blue lighten-1">
    ...
    <li class="custom-background"><a href="opd.php"><i class="fas fa-box"></i> Outpatient</a></li>
    <li ><a href="ipd.php"><i class="fas fa-box"></i> Inpatient</a></li>
...
<table id="yourTableID" class="display" >
    ...
    <h5 id="totalLabel">Subtotal :  <center><span id="totalValue">0.00</span></center></h5>
...
<div class="overlay1" id="overlay1">
    <div class="form-container1" id="form-container1">
        <form id="updateForm" action="insertorderopd.php" method="post">
...
<script>
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'insertorderopd.php', // Update with your PHP script URL
            data: {
                id: id,
                quantity: quantity,
                article: article,
