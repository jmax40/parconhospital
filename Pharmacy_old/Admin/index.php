    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Ken Kandidus</strong>
                                        </h5>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $session_id; ?> <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-user"></i> Manage Acount <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                        <li>
    <a href="#"><i class="fa fa-fw fa-user"></i> Stocker Account</a>
</li>

<li>
    <a href="#"><i class="fa fa-fw fa-user"></i> Pharmacy's Account</a>
</li>
                        </ul>
                    </li>
            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> <?php echo $stockofthemonth[0]['quantity'];?> </div>
                                        <div>New Stock / Monthly</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $value[0]['cost'];?></div>
                                        <div> Pharmacy's Sales / Daily </div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $totalstock[0]['quantity'];?></div>
                                        <div>Pharmacy's Stocks</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $reorder[0]['quantity'];?></div>
                                        <div>Low's Stock</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Montly Sales Performance </h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Monthly Pharmacy Performance </h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Individual Sales </h3>
                            </div>
                            <div class="panel-body">
...
while ($row = $Sales_report->fetch_assoc()):
    ...
    $dateTime = DateTime::createFromFormat('m-d-Y H:i:s', $dateTimeCombined);
