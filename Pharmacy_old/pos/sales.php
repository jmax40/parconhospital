...
<table id="yourTableID" class="display">
    ...
    <tbody>
        ...
        while ($row = $Sales_report->fetch_assoc()):
            ...
            $dateTimeCombined = $row['outduty']; // Assuming the date and time are in the 'outduty' column
            ...
            if (!array_key_exists($uniqueKey, $uniqueStockerData)) {
                ...
                $uniqueStockerData[$uniqueKey] = array(
                    ...
                    'time' => $time,
                    'totalCost' => $price,
                    'dateTimeCombined' => $dateTimeCombined  // Store the unique outduty value
                );
            } else {
        ...
        ?>
            <tr>
                ...
                <td><?php echo $stockerInfo['dateTimeCombined'] ?></td>
                <td>
